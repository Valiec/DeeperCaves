...
public class ChunkProviderBedrockPlanes implements IChunkProvider
{
    /** RNG. */
    private Random rand;
    ...
    private MapGenBase caveGenerator = new MapGenDeeperCaves();
    ...
    public ChunkProviderBedrockPlanes(World par1World, long par2, boolean par4)
    {
