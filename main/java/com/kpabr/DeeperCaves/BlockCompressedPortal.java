...
public class BlockCompressedPortal extends Block
{
    public static boolean field_149948_a;
    private static final String __OBFID = "CL_00000236";

    protected BlockCompressedPortal(Material p_i45404_1_)
    {
        super(p_i45404_1_);
    ...
    public void onEntityCollidedWithBlock(World p_149670_1_, int p_149670_2_, int p_149670_3_, int p_149670_4_, Entity p_149670_5_)
    {
        if (p_149670_5_.ridingEntity == null && p_149670_5_.riddenByEntity == null && !p_149670_1_.isRemote)
        {
        	...
        	System.out.println("DIM10");
        	//p_149670_5_.timeUntilPortal = 100;
        	try
        	{
        	EntityPlayerMP player = (EntityPlayerMP)p_149670_5_;
        	if(player.dimension != 10)
        	{
        	player.mcServer.getConfigurationManager().transferPlayerToDimension(player, 10, new DeeperTeleporter(player.mcServer.worldServerForDimension(10)));
        	}
        	}
