...
public class NoiseGeneratorOctavesOpenSimplex extends NoiseGenerator
{
    /** Collection of noise generation functions.  Output is combined to produce different octaves of noise. */
    private NoiseGeneratorOpenSimplex[] generatorCollection;
    private int octaves;

    public NoiseGeneratorOctavesOpenSimplex(Random p_i2111_1_, int p_i2111_2_)
    {
        this.octaves = p_i2111_2_;
        this.generatorCollection = new NoiseGeneratorOpenSimplex[p_i2111_2_];

        for (int j = 0; j < p_i2111_2_; ++j)
        {
            this.generatorCollection[j] = new NoiseGeneratorOpenSimplex(p_i2111_1_.nextLong());
        }
    }
    ...
    {
        return generateNoiseOctaves(p_76304_1_, p_76304_2_, p_76304_3_, p_76304_4_, p_76304_5_, p_76304_6_, p_76304_7_, p_76304_8_, p_76304_10_, p_76304_12_, 2.0);
    }


    public double[] generateNoiseOctaves(double[] p_76304_1_, int p_76304_2_, int p_76304_3_, int p_76304_4_, int p_76304_5_, int p_76304_6_, int p_76304_7_, double p_76304_8_, double p_76304_10_, double p_76304_12_, double octaveRatio)
    {
        if (p_76304_1_ == null)
        {
