...
public class BedrockPlainsRavineCarver extends RavineCarver {
    public BedrockPlainsRavineCarver(Codec<RavineCarverConfig> codec) {
        super(codec);

    }

    @Override
    public boolean carve(CarverContext carverContext, RavineCarverConfig caveCarverConfig, Chunk chunk, Function<BlockPos, RegistryEntry<Biome>> function, Random random, AquiferSampler aquiferSampler, ChunkPos chunkPos, CarvingMask carvingMask) {
