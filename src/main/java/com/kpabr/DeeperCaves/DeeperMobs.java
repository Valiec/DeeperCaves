...
public class DeeperMobs {
    ...
    public void setupMobs()
    {
        ...
        EntityRegistry.addSpawn(EntityDeepZombie.class, 100, 4, 4, EnumCreatureType.monster, DeeperCaves.worldgen.deepWorld.biomes.get("Deep World"));
        EntityRegistry.registerGlobalEntityID(EntityDeepSkeleton.class, "deepSkeleton", this.deepSkeletonID, 0x8A8A8A, 0x0A0A0A);
        EntityRegistry.addSpawn(EntityDeepSkeleton.class, 100, 4, 4, EnumCreatureType.monster, DeeperCaves.worldgen.deepWorld.biomes.get("Deep World"));
        EntityRegistry.registerGlobalEntityID(EntityDeepCaveSpider.class, "deepCaveSpider", this.deepCaveSpiderID, 0x00141F, 0x5B0000);
        EntityRegistry.addSpawn(EntityDeepCaveSpider.class, 100, 4, 4, EnumCreatureType.monster, DeeperCaves.worldgen.deepWorld.biomes.get("Deep World"));
        EntityRegistry.registerGlobalEntityID(EntityDeepCreeper.class, "deepCreeper", this.deepCreeperID, 0x007200, 0x000000);
        EntityRegistry.addSpawn(EntityDeepCreeper.class, 100, 4, 4, EnumCreatureType.monster, DeeperCaves.worldgen.deepWorld.biomes.get("Deep World"));
        ...
        EntityRegistry.addSpawn(EntityMutatedCaveSpider.class, 100, 4, 4, EnumCreatureType.monster, DeeperCaves.worldgen.mutation.biomes.get("Mutation"));
        EntityRegistry.registerGlobalEntityID(EntityMutatedZombie.class, "mutatedZombie", this.mutatedZombieID, 0x007A7A, 0x365226);
        EntityRegistry.addSpawn(EntityMutatedZombie.class, 100, 4, 4, EnumCreatureType.monster, DeeperCaves.worldgen.mutation.biomes.get("Mutation"));
        ...
        EntityRegistry.addSpawn(EntityMutatedSkeleton.class, 100, 4, 4, EnumCreatureType.monster, DeeperCaves.worldgen.mutation.biomes.get("Mutation"));
        EntityRegistry.registerGlobalEntityID(EntityMutatedCreeper.class, "mutatedCreeper", this.mutatedCreeperID, 0x007200, 0x000000);
        EntityRegistry.addSpawn(EntityMutatedCreeper.class, 100, 4, 4, EnumCreatureType.monster, DeeperCaves.worldgen.mutation.biomes.get("Mutation"));
        
        EntityRegistry.registerGlobalEntityID(EntityShadow.class, "Shadow", this.shadowID, 0x050505, 0x7C0000);
        EntityRegistry.addSpawn(EntityShadow.class, 100, 4, 4, EnumCreatureType.monster, DeeperCaves.worldgen.darkness.biomes.get("Darkness"));
