...
public class BiomeGenNearNetherBasalt extends BiomeGenNearNether
{
    public BiomeGenNearNetherBasalt(int biomeID)
    {
        super(biomeID);
    ...
    public void generateOres(World world, Random random, int x, int z) {
        ...
        LayerOregen.addOre(DeeperBlocks.fragmentedBedrock, world, random, x, z, 16, 16, 8, 55, 0, 255, DeeperBlocks.basalt);
