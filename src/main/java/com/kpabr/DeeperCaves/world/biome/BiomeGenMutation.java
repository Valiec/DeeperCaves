...
public class BiomeGenMutation extends BiomeGenDeeperCavesBase
{
    ...
    public void generateOres(World world, Random random, int x, int z) {
        ...
        LayerOregen.addOre(DeeperBlocks.ddsilverOre, world, random, x, z, 16, 16, 4, 32, 0, 255, DeeperBlocks.darkStone);

        for(int i = 0; i<16; i++)
        {
            LayerOregen.addOre(DeeperBlocks.crystal, i, world, random, x, z, 16, 16, 24, 2, 0, 255, DeeperBlocks.darkStone);
        }
    }
}