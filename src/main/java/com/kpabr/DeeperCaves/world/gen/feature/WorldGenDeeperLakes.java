...
public class WorldGenDeeperLakes extends WorldGenerator
{
    private Block field_150556_a;
    private Block field_150556_b;
                ...
                for (i1 = 0; i1 < 16; ++i1)
                {
                    for (j2 = 0; j2 < 16; ++j2)
                    {
                        for (j1 = 0; j1 < 8; ++j1)
                        {
                            ...
                            {
                                p_76484_1_.setBlock(p_76484_3_ + i1, p_76484_4_ + j1, p_76484_5_ + j2, this.field_150556_b, 0, 2);
                            }
                        }
                    }
                }
