...
{
    private MapGenBase caveGenerator = new MapGenDeeperCavesDefault(false, 1.0F, 1.5D, 255, 0, 0, 47, 4, true, false, DeeperBlocks.darkStone);
    private MapGenBase ravineGenerator = new MapGenDeeperRavine(234, 15, 7.5, 3.5, DeeperBlocks.darkStone);
