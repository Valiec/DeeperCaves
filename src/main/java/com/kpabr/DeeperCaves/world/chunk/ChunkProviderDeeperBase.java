...
public abstract class ChunkProviderDeeperBase extends ChunkProviderGenerate implements IChunkProvider
{
    /** RNG. */
    Random rand;
    NoiseGeneratorOctaves field_147431_j;
    NoiseGeneratorOctaves field_147432_k;
    NoiseGeneratorOctaves field_147429_l;
    ...
    public void initWorldBlocks(int p_147424_1_, int p_147424_2_, Block[] p_147424_3_)
    {
        ...
        this.initWorldNoise(p_147424_1_ * 4, 0, p_147424_2_ * 4);
    ...
    public void initWorldNoise(int p_147423_1_, int p_147423_2_, int p_147423_3_)
    {
        double d0 = 684.412D;
        double d1 = 684.412D;
        double d2 = 512.0D;
