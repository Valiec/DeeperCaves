...
{
    private MapGenBase caveGenerator = new MapGenDeeperCavesDefault(DeeperBlocks.abandonedStone);
    private MapGenBase ravineGenerator = new MapGenDeeperRavine(234, 3, 1.5, 1.0, DeeperBlocks.abandonedStone);
