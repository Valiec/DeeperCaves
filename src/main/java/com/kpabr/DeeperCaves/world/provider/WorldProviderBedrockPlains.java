...
import com.kpabr.DeeperCaves.world.chunk.ChunkProviderBedrockPlains;
 ...
 */
public class WorldProviderBedrockPlains extends WorldProvider
{
    /**
    ...
    public void registerWorldChunkManager()
    {
        ...
        this.dimensionId = DeeperCaves.worldgen.bedrockPlainsDimID;
        this.hasNoSky = true;
    }
    ...
    public IChunkProvider createChunkGenerator()
    {
    	...
    	return new ChunkProviderBedrockPlains(this.worldObj, this.worldObj.getSeed()+5, true);
    }
