 ...
 */
public class WorldProviderCompressed extends WorldProvider
{
    /**
    ...
    {
        this.worldChunkMgr = new WorldChunkManagerHell(DeeperCaves.worldgen.biomeCompressed, 0.5F);
        this.dimensionId = DeeperCaves.worldgen.compressedDimID;
        this.hasNoSky = true;
    }
