...
public class BlockVanillaRedstoneOre extends BlockCompressedOre {
	
	private boolean glow;
	
	public BlockVanillaRedstoneOre(boolean glow){
    ...
    private void func_150185_e(World p_150185_1_, int p_150185_2_, int p_150185_3_, int p_150185_4_)
    {
        ...
        if (this == DeeperBlocks.dredstoneOre)
        {
            p_150185_1_.setBlock(p_150185_2_, p_150185_3_, p_150185_4_, DeeperBlocks.dredstoneOre_glowing);
        }
    }
    public void updateTick(World p_149674_1_, int p_149674_2_, int p_149674_3_, int p_149674_4_, Random p_149674_5_)
    {
        if (this == DeeperBlocks.dredstoneOre_glowing)
        {
            p_149674_1_.setBlock(p_149674_2_, p_149674_3_, p_149674_4_, DeeperBlocks.dredstoneOre);
        }
    }
    ...
    {
        return new ItemStack(DeeperBlocks.dredstoneOre);
    }
