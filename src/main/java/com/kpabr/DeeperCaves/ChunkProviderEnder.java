...
public class ChunkProviderEnder implements IChunkProvider
{
        ...
        for (int k = 0; k < 16; ++k)
        {
            for (int l = 0; l < 16; ++l)
            {
                ...
                for (int j1 = 127; j1 >= 0; --j1)
                {
                    ...
                    {
                        if (block2 == Blocks.stone || block2 == Blocks.stone)
                        {
                            if (i1 == -1)
                            {
                                if (b0 <= 0)
    ...
    public Chunk provideChunk(int par1, int par2)
    {
        ...
        MapGenBase ravine = new MapGenRavine();
    	System.out.println("Generatong Ravines!IIUYGHJKJHGFHIJKJHGFDGHJUHGFGHJKHGFVCDFGHJKHGFDFGHJ");
    	ravine.func_151539_a(this, this.endWorld, par1, par2, ablock);
