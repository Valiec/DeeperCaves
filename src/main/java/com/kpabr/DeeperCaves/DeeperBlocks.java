...
public class DeeperBlocks {
    ...
    public void setupBlocks()
    {
        ...
        DeeperBlocks.sculkVines = new BlockSculkVine(DeeperMaterials.sculk).setStepSound(DeeperMaterials.sculkVeinSound).setLightLevel(4.0F).setBlockTextureName("deepercaves:sculk_vines").setBlockName("sculkVines").setHardness(0.2F).setResistance(0.2F).setCreativeTab(DeeperCaves.tabDeeperCaves);
        DeeperBlocks.sculkKelp = new BlockSculkTendril(DeeperMaterials.sculk).setStepSound(DeeperMaterials.sculkVeinSound).setLightLevel(2.7F).setBlockTextureName("deepercaves:sculk_kelp").setBlockName("sculkKelp").setHardness(0.2F).setResistance(0.2F).setCreativeTab(DeeperCaves.tabDeeperCaves);
        DeeperBlocks.sculkKelpRoot = new BlockSculkTendrilRoot(DeeperMaterials.sculk).setStepSound(DeeperMaterials.sculkVeinSound).setLightLevel(2.7F).setBlockTextureName("deepercaves:sculk_kelp").setBlockName("sculkKelpRoot").setHardness(0.2F).setResistance(0.2F);
